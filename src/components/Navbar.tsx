  ...
  return (
    <>
      <nav className="fixed top-0 left-0 w-full z-[999] transition-all">
        {/* Solid strip to block content bleed through pt-3 gap */}

        <div className="px-4 pt-3">
          <div className="
            max-w-7xl mx-auto h-[68px] rounded-[22px]
            bg-white/90 dark:bg-[#070C18]/90
            backdrop-blur-2xl
          ...
          ">
            ...
            <a href="#home" className="flex items-center gap-3 shrink-0">
              <motion.div
                ...
                className="w-10 h-10 rounded-[14px] flex items-center justify-center text-white font-bold text-sm bg-gradient-to-br from-blue-600 via-purple-600 to-pink-500 shadow-lg"
              >
                R
              </motion.div>
              <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="lg:hidden w-10 h-10 rounded-xl bg-black/[0.04] dark:bg-white/[0.05] flex items-center justify-center text-gray-700 dark:text-gray-300"
              >
