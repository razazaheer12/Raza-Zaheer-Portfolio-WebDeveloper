...
const Contact = () => {
  ...
  const socialLinks = [
    ...
    { href: 'https://www.linkedin.com/in/raza-zaheer-416745340/', icon: <Linkedin size={20} />, label: 'LinkedIn', gradient: 'from-blue-600 to-blue-700', hoverShadow: 'hover:shadow-blue-500/30' },
  ];
