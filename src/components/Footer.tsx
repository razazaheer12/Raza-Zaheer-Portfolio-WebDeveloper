    ...
    <>
      <nav className="fixed top-0 left-0 w-full z-[999]">
        ...
        <div className="px-4 pt-3">
          {/* NAVBAR */}
          <div className="relative max-w-7xl mx-auto h-[68px] rounded-[22px] bg-white/75 dark:bg-[#070C18]/80 backdrop-blur-2xl border border-transparent shadow-[0_8px_40px_rgba(0,0,0,0.06)] dark:shadow-[0_8px_40px_rgba(0,0,0,0.35)] flex items-center justify-between px-5 lg:px-8 overflow-hidden">
            {/* SCROLL PROGRESS BAR — dynamically fills as the page scrolls */}
            <motion.div
              style={{ width: progressWidth }}
              className="absolute bottom-0 left-0 h-[3px] rounded-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 shadow-[0_0_10px_rgba(139,92,255,0.6)]"
            />
            ...
            <a href="#home" className="flex items-center gap-3 shrink-0">
              <motion.div
                ...
                className="w-10 h-10 rounded-[14px] flex items-center justify-center text-white font-bold bg-gradient-to-br from-blue-600 via-purple-600 to-pink-500"
              >
                RZ
              </motion.div>
            ...
            <div className="hidden lg:flex items-center gap-5">
              ...
              {/* ICON ONLY */}
              <div className="[&>button]:bg-transparent [&>button]:border-0 [&>button]:shadow-none [&_svg]:w-6 [&_svg]:h-6">
                <ThemeToggle />
              </div>
            </div>
          ...
          {isOpen && (
            ...
            >
              ...
              {/* TOGGLE LAST */}
              <div className="border-t border-gray-100 dark:border-white/[0.06] py-5 flex justify-center [&>button]:bg-transparent [&>button]:border-0 [&>button]:shadow-none">
                <ThemeToggle />
              </div>
            </motion.div>
          )}
